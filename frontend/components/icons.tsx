...
export function IconPortfolio({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.449.148-.9.286-1.35.408m-13.5 0c-.449-.122-.9-.24-1.35-.408m13.5 0c1.49-1.46 3-3.88 3-6.406 0-1.72-1.02-3.14-2.5-3.7m-11 0C4.02 8.02 3 9.44 3 11.16c0 2.526 1.51 4.946 3 6.406" />
    </svg>
  );
}
...
export function IconFilter({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6.75h10.5m-10.5 0a1.5 1.5 0 1 0 0 3m10.5-3a1.5 1.5 0 1 0 0 3M3 6.75h3m-3 10.5h10.5m-10.5 0a1.5 1.5 0 1 0 0 3m10.5-3a1.5 1.5 0 1 0 0 3M17.25 12h3" />
    </svg>
  );
}
...
export function IconCertificate({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" aria-hidden>
...
export function IconBookOpen({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" aria-hidden>
