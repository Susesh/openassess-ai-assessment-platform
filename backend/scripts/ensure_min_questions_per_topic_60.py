"""Ensure each topic has a minimum number of questions (60).

Run:
    backend\venv\Scripts\python.exe backend\scripts\ensure_min_questions_per_topic_60.py
"""
import sys
import os
...
def ensure_min_questions():
    ...
    try:
        ...
        for topic in topics:
            ...
            added = 0
            offset = qcount * 7
            while qcount + added < MIN_PER_TOPIC and i < 3000:
